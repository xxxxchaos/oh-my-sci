...
const agents: AgentDef[] = [
  { name: 'dubin', mode: 'primary', description: '医学研究主编排者。引导结构化访谈，拆解委派任务，调和审稿冲突，确保研究全流程质量。' },
  { name: 'archimedes', mode: 'subagent', description: '研究设计师。PICO框架提取、FINER评估、研究类型判定、样本量计算、偏倚控制策略。' },
  { name: 'irber', mode: 'subagent', description: '计划审查员。方案质量审查、FINER评分、伦理风险预审、阻塞项标记。只读。' },
  { name: 'pubmeder', mode: 'subagent', description: '文献搜索员。多源并行检索(PubMed/CNKI/Cochrane/Exa/Consensus)，四色分类证据矩阵，效应量提取。' },
  { name: 'spsser', mode: 'subagent', description: '统计分析师。SAP撰写、R分析执行、8项诊断、敏感性分析(PSM/IPTW/MICE)、Tables+Figures生成。' },
  { name: 'writer', mode: 'subagent', description: '论文写作者。根据已签核结果生成初稿(中/英文)、目标期刊格式适配、参考文献审计。' },
  { name: 'submitter', mode: 'subagent', description: '投稿协调员。期刊匹配分析、投稿包生成、格式转换、26项投稿检查。' },
  { name: 'ebmer', mode: 'subagent', description: '方法学审稿人。Sprint Contract两阶段盲审、12模式临床失败检查、数据一致性验证。只读。' },
  { name: 'polisher', mode: 'subagent', description: '逻辑审稿人。逻辑链连贯性检查、去AI味扫描、语言质量审查。只读。' },
];
